...
export default async function SitePage() {
  const [heroContent, contactContent, testimonials] = await Promise.all([
  ...
  return (
    <div className="p-8 max-w-4xl space-y-8">
      <div>
        ...
        <h1 className="font-display text-5xl tracking-widest">SITE</h1>
        <p className="text-muted text-sm mt-1">Manage homepage content, testimonials, and contact details.</p>
      </div>
